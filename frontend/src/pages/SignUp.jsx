...
//     if (!isEmailVerified) {
//       setVerificationError("Please verify your email before registering");
//       return;
//     }
...
//       // In a real app, this would be sent by the server
...
//     setTimeout(() => {
//       // Mock verification - in real app, this would be validated on server
...
//                       value={email}
//                       onChange={(e) => setEmail(e.target.value)}
//                       className={`text-[16px] py-2 bg-transparent border-b-[1px] ${
//                         isEmailVerified ? "border-green-500" : "border-b-stone-500"
//                       } focus:outline-none flex-1`}
//                       disabled={isEmailVerified}
//                     />
//                     {!isEmailVerified && !showVerification && (
//                       <button
//                         type="button"
//                         onClick={sendVerificationCode}
//                         className="bg-[#d6482b] text-white px-3 py-1 rounded-md text-sm"
...
//                         className="text-[#d6482b] text-sm underline"
//                       >
//                         Change
//                       </button>
//                     )}
...
//                           className="text-[16px] py-1 px-2 bg-transparent border-[1px] border-stone-500 focus:outline-none flex-1 rounded-md"
//                           maxLength={6}
//                         />
//                         <button
//                           type="button"
...
//                       </div>
//                       {verificationError && (
//                         <span className="text-red-500 text-sm mt-1">{verificationError}</span>
//                       )}
//                     </div>
//                   )}
//                 </div>
...
//             >
//               {loading && "Registering..."}
//               {!loading && !isEmailVerified && "Verify Email to Register"}
//               {!loading && isEmailVerified && "Register"}
//             </button>
//           </form>
//         </div>
//       </section>
